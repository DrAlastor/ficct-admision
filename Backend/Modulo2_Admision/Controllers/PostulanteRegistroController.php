...
namespace Backend\Modulo2_Admision\Controllers;
...
use Backend\Modulo2_Admision\Models\Usuario;
use Backend\Modulo2_Admision\Models\Perfil;
use Backend\Modulo2_Admision\Models\Postulante;
use Backend\Modulo2_Admision\Models\Postulacion;
use Backend\Modulo2_Admision\Models\Pago;
use Backend\Modulo2_Admision\Models\Documento;
use Inertia\Inertia;
use Stripe\Stripe;
...
class PostulanteRegistroController extends Controller
{
    ...
    {
        return Inertia::render('Modulos/Modulo2_Admision/Index');
    }
